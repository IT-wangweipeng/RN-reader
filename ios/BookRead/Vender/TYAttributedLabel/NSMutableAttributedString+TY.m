...
//    [self addAttributeAlignmentStyle:textAlignment lineSpaceStyle:linesSpacing paragraphSpaceStyle:paragraphSpacing lineBreakStyle:lineBreakMode range:NSMakeRange(0, self.length)];
      [self addAttributeAlignmentStyle:textAlignment lineSpaceStyle:linesSpacing paragraphSpaceStyle:paragraphSpacing lineBreakStyle:lineBreakMode range:NSMakeRange(0, self.length) lineIndent:lineIndent font:font];
}
                              ...
                              font:(UIFont *)font
{
  ...
  //首行缩进
//  CGFloat fristlineindent = self.font.pointSize*config.lineIndent;
//  CGFloat fristlineindent = [UIFont systemFontOfSize:[TReaderManager fontSize]].pointSize  * 2;
  CGFloat fristlineindent = font.pointSize * lineIndent;
  ...
  fristline.valueSize = sizeof(CGFloat);
    ...
    // 创建样式数组
    CTParagraphStyleSetting settings[] = {alignmentStyle ,lineSpaceStyle, paragraphSpaceStyle, lineBreakStyle, fristline};
