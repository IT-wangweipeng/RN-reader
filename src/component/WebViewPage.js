...
class WebViewPage extends Component {
  ...
  _loadVideoAd() {
    ...
    if (url && (url.includes(Config.url.withdraw()) || url.includes(Config.url.missionURL()) || url.includes(Config.hotBeans.mineURL()))) {
      if (!isIOS()) {
    ...
    return (
      <View style={{flex: 1}}>
        <WebView
          ...
          onNavigationStateChange={this.props.stopNavigationStateChange ? null : this._onNavigationStateChange}
          ...
          injectJavaScript={patchPostMessageJsCode}
        />
      </View>
    )
  }
...
}, mapDispatchToProps)(WebViewPage)
