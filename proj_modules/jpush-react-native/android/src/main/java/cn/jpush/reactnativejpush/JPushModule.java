        ...
        public void onReceive(Context context, Intent data) {
            ...
            if (JPushInterface.ACTION_MESSAGE_RECEIVED.equals(data.getAction())) {
                ...
                try {
                    ...
                    //*/ modified by zhengguang.yang, 20190517
                    //if (isApplicationRunningBackground(context)) {
                      Logger.d(TAG, "isApplicationRunningBackground true");
                      //Intent intent = context.getPackageManager().getLaunchIntentForPackage(context.getPackageName());
                      //intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                      Intent intent = new Intent();
                      intent.setClassName("com.droi.reader", "com.droi.reader.MainActivity");
                      intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                      intent.putExtras(mCachedBundle);
                      context.startActivity(intent);
                    //} else {
                    //  Logger.d(TAG, "isApplicationRunningBackground false");
                    //}
                    //*/
