...
import com.droi.reader.widget.page.PageMode;
...
public class ReadSettingManager {
    ...
    public static final String SHARED_READ_LAST_BG = "shared_read_last_bg";
    ...
    public void setLastPageStyle(PageStyle pageStyle) {
        sharedPreUtils.putInt(SHARED_READ_LAST_BG, pageStyle.ordinal());
    }
    ...
    public int getBrightness() {
        return sharedPreUtils.getInt(SHARED_READ_BRIGHTNESS, 255);
    }
    ...
    public int getTextSize() {
        return sharedPreUtils.getInt(SHARED_READ_TEXT_SIZE, -1);
    }
    ...
    public PageStyle getLastPageStyle() {
        int style = sharedPreUtils.getInt(SHARED_READ_LAST_BG, PageStyle.BG_0.ordinal());
        return PageStyle.values()[style];
    }
