...
//    }
     ...
     * @return
     */
    public static File getBookFile(long bookId, long chapterId, String title) {
        return FileUtils.getFile(Constant.BOOK_CACHE_PATH + bookId
                + File.separator + chapterId + title + FileUtils.SUFFIX_NB);
    }
...
//    }
     ...
     * @return
     */
    public static boolean isChapterCached(long bookId, long chapterId, String title) {
        File file = new File(Constant.BOOK_CACHE_PATH + bookId
                + File.separator + chapterId + title + FileUtils.SUFFIX_NB);
        return file.exists();
    }
